...
enum game_rules_bitfield { // used by GameRules
	...
	RULES_SCENRULE_UNITY_PODS_NO_RESOURCES = 0x10000,
	RULES_SCENRULE_UNITY_PODS_NO_MONOLITHS = 0x20000,
	RULES_SCENRULE_UNITY_PODS_NO_ARTIFACTS = 0x40000,
	RULES_SCN_VICT_SOLO_MISSION = 0x80000,
	RULES_SCENRULE_FORCE_PLAYER_PLAY_CURRENT_FACT = 0x100000,
	RULES_SCENRULE_NO_NATIVE_LIFE = 0x200000,
	RULES_SCENRULE_NO_COLONY_PODS = 0x400000,
	RULES_SCENRULE_NO_TERRAFORMING = 0x800000,
	RULES_SCENRULE_FORCE_CURRENT_DIFF_LEVEL = 0x1000000,
	RULES_SCENRULE_NO_TECH_TRADING = 0x2000000,
	RULES_SCENRULE_NO_TECH_ADVANCES = 0x4000000,
	...
	RULES_SCENRULE_NO_BUILDING_SP = 0x80000000,
};
